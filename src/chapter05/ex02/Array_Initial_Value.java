...
public class Array_Initial_Value {
	public static void main(String[] args) {
		...
		// 1.Stack 메모리값 ( 강제 초기확 되지 않음 )	<== 기본 자료형의 값
			int val1 ; 		// 변수 선언
			...
			System.out.println(val2); 		// 객체의 힙영역의 주소가 출력됨, 16진수로 출력됨
			...
			System.out.println(val3);		// 객체 자체를 출력할 때 Stack에 저장된 Heap의 주소 : 16진수
			val3 = new int [4];
		...
		// 2. Heap 메모리값 ( 강제 초기화가 됨 )	<== 참조 자료형의 값
			...
			System.out.println(a[0]);		//기본값 false
			...
			// Array.toString(배열변수) ;		// 배열의 모든 값을 출력
