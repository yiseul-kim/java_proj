...
public class Main_Method_Argument {
	...
	/*
	 	Method ( 메소드 ) : C에서 함수를 객체 지향 언어(OOP:Object Oriented Programming)에서 메소드라 호칭
	 		
	 		- 접근지정자 반환타입 메소드명 (인풋매개변수) {
	 			실행블락
	 		}
	 		->  public static(접근지정자) void(반환타입) main(메소드명)(String[] args) { } (인풋매개변수){}
	 */
		...
		System.out.println("==========================");
		// main 메소드의 매개 변수 args로 들어오는 값을 for문을 사용해 출력
