		 	...
		 	1. Error vs Exception
		  	...
		  	2. Exception (예외)
		  			- 일반 예외 (checked Exception)
		  				: 컴파일러가 체크를 하고 이클립스에서 알려줌.

		  			- 실행 예외 (Runtime Exception) or (Unchecked Exception)
		  				: 컴파일러가 체크하지 않고 실행시에 예외 발생
		 */
		
		// 1. Interrupted Exception : 인터럽트가 발생되었을 때 예외
//		Thread.sleep(1000);			// 스레드를 1초동안 멈추어라. 
