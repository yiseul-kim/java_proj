...
public class BitwiseOperator {
	...
	public static void main(String[] args) {
		...
		//2. 2, 8, 16  ==> 10진수로 표현 
		System.out.println(Integer.parseInt("1101", 2));	// 13 (2진수를 10진수로 출력)
		System.out.println(Integer.parseInt("15", 8));		// 13 (8진수를 10진수로 출력)
		System.out.println(Integer.parseInt("d", 16));		// 13 (16진수를 10진수로 출력)
		
		System.out.println("====================================");
		
		// 문자열로 된 숫자를 정수로 변환 해서 연산을 함...  clinet 폼에서 ====> 서버로 숫자를 전송
		...
		System.out.println(a+b);  // 13.313.4 String = 연결되서 나옴
