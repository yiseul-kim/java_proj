...
public class This_Method {
	public static void main(String[] args) {
		/*
			this() 메소드 : 	생성자 호출할 때 사용됨 
				- 생성자 내부에서 사용됨.
				- 생성자 첫라인에 와야함.
				- 생성자 내부에서 다른 생성자를 호출할 때 사용됨.
				- 시그니처에 따라서 생성자를 호출 : 아규먼트(인풋매개변수) 갯수,아규먼트의 타입 
		 */
		
		// C 클래스로 객체를 생성후 생성자 호출 후 각 필드의 내용 출력 
		C c1 = new C();			//기본 생성자 호출
		C c2 = new C(10);						//생성자 호출
		C c3 = new C(100, 200);					//생성자 호출 1
		C c4 = new C(1000, 2000, 3000);			//생성자 호출 2
