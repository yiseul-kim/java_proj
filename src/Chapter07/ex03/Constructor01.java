...
class Student {
	...
	//기본생성자 : 객체의 다른 생성자가 존재시 기본 생성자를 명시적으로 만들어줘야함
	public Student () {}
	
	//생성자 : 매개변수로 1개 인풋 받는 생성자
		// this : 자기 자신의 객체를 뜻함.
		// (매개변수로 들어오는 변수명), (매개변수로 들어오는 변수를 받는 변수명), (필드명) 3가지 이름이 동일한 경우 (색이 셋다 갈색일 경우)
		// 			필드명에 this. 키워드를 넣어야 한다. 
	public Student(String stuName) { 
		this.stuName = stuName;		// this 를 넣어줘야하는 상황 : 필드명은 파랑이여야함. 앞에 stuName이 갈색이면 ㄴㄴ 
	}
	...
	// 생성자 간편 호출 - alt + shift + s -> generate constructor using fields
...
public class Constructor01 {
	public static void main(String[] args) {
		...
		Student s4 = new Student("세종대왕","서울 종로","aaa@aaa.com");	//매개변수 3개 생성자 호출 
		Student s5 = new Student("신사임당", "강원도", "bbb@bbb.com", 30);	//매개변수 4개 생성자 호출
		Student s6 = new Student("을지문덕", "함경북도", "ccc@ccc.com", 40, 70.7);	//매개변수 5개 생성자 호출
