...
class GenericMethod {		//일반 클래스 
	...
	public <T> boolean method2(T t1, T t2) {
		...
		return t1.equals(t2);		// 스택의 값을 비교 ,  String은 equals()	  메소드가 
	}
	...
	public < K, V > void method4 (V v) {
		...
		System.out.println("반드시 타입을 지정해서 호출 되어야 함 : 매개변수에서 타입을 유추 할 수 없기 때문" );
	}
}
...
public class Genericmethod01 {
	public static void main(String[] args) {
		...
		Integer i2 = gm. method(20); 			//제너릭 메소드 호출시 타입을 생략 해서 호출 ( 약식 표현 )
