...
class A {		//일반 클래스에 제너릭 메소드
	...
	//인터페이스 : 제너릭 타입의 제한시 인터페이스일때 다중 제한 이 가능하다. 	
					//	- 클래스 일때는 하나만 처리할 수 있다. 
...
class Aa implements IF1 {
	...
	@Override
	public void print() {
		System.out.println("Aa 구현된 메소드 - 메소드 호출");		
	}
}
class Aaa extends Aa {
	@Override
	public void print() {
		System.out.println("Aaa 구현된 메소드 - 오버라이딩");		
	} 
...
//		a.<String> method1("안녕"); 	//Number의 자식 클래스가 안들어가서 오류
		...
		b1.<Aa> method1 (new Aa());				// Aa객체를 Aa타입으로 둠, 메소드 호출 
